...
public class HUDFragment extends Fragment {
    ...
    HUDwidget hudWidget;//to fragment
    private OnHUDFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.hud_fragment, container, false);
        hudWidget = (HUDwidget) rootView.findViewById(R.id.hudWidget);
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnHUDFragmentInteractionListener) activity;
     ...
     */
    public interface OnHUDFragmentInteractionListener {
